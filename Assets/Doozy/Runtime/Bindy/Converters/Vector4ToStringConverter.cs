...
{
    /// <summary>
    /// Converts a Vector4 value to a string value and vice-versa.
    /// This implementation converts the Vector4 to and from a string in the format "x,y,z,w".
    /// </summary>
    public class Vector4ToStringConverter : IValueConverter
    {
        ...
        /// </summary>
        public Type sourceType => typeof(Vector4);
        ...
        public bool CanConvert(Type source, Type target) =>
            source == typeof(Vector4) && target == typeof(string);
        ...
        public object Convert(object value, Type target)
        {
            ...
            if (value is Vector4 vectorValue)
                return $"{vectorValue.x},{vectorValue.y},{vectorValue.z},{vectorValue.w}";

            throw new ArgumentException($"Invalid source type: {value.GetType()}. Expected: {typeof(Vector4)}.");
        }
    }
}