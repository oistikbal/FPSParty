...
{
    [CustomEditor(typeof(Vector2ToFloatTransformer), true)]
    public class Vector2ToFloatTransformerEditor : ValueTransformerEditor
    {
        ...
        protected override void InitializeCustomInspector()
        {
            EnumField axisEnumField =
                DesignUtils.NewEnumField(propertyAxis)
                    .SetStyleFlexGrow(1)
                    .SetTooltip("The axis to use when converting the Vector2 value to a float value");
            ...
            IntegerField decimalPlacesIntegerField =
                DesignUtils.NewIntegerField(propertyDecimalPlaces)
                    .SetStyleFlexGrow(1)
                    .SetTooltip("The number of decimal places to use when converting the Vector2 value to a float value");
